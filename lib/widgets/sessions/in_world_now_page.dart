...
/// Shown in the "Now" tab when the user is in a session (e.g. hosting in Resonite).
class InWorldNowPage extends StatefulWidget {
  const InWorldNowPage({required this.session, super.key});

  final Session session;

  @override
  State<InWorldNowPage> createState() => _InWorldNowPageState();
}

class _InWorldNowPageState extends State<InWorldNowPage> {
  ...
  @override
  void didUpdateWidget(covariant InWorldNowPage oldWidget) {
  ...
  Future<void> _onRefresh() async {
    ...
    await sessionClient.refreshCurrentSession();
    final session = sessionClient.currentSession;
